...
namespace FilmManagement.Persistence.EntityConfigurations
{
    public class FilmConfiguration : IEntityTypeConfiguration<Film>
    {
        public void Configure(EntityTypeBuilder<Film> builder)
        {
            ...
            builder.Property(f => f.Image).HasColumnName("Image");
            builder.Property(f => f.Video).HasColumnName("Video");
            ...
            builder.HasQueryFilter(f => !f.DeletedDate.HasValue);//Delete tarihinde değer olmayanlar gelir.
        }
    }
}
